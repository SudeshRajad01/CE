...
router.post('/register', async (req, res) =>{
    ...
    const {name, email, studentid, password, cpassword} = req.body;

    if (!name || !email || !studentid || !password || !cpassword) {
    ...
    try {
        ...
        if (userExist) {
            ...
            const user = new User({name, email, studentid, password, cpassword});
